                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('todos.save')}}" method="post">  
                                    ...
                                    <div class="add-items d-flex"> 
                                        ...
                                        <input type="text" name="name" class="form-control todo-list-input" placeholder="What do you need to do today?" value=""> 
                                ...
                                <div class="list-wrapper">
                                    ...
                                    <ul class="d-flex flex-column-reverse todo-list">
                                        ...
                                        <li>
                                            <div class="form-check"> <label class="form-check-label"> <input class="checkbox" type="checkbox">{{$todo->name}}<i class="input-helper"></i></label> </div> <a href="{{route('todos.delete',['todo_id' => $todo->id])}}"><i class="remove mdi mdi-close-circle-outline" onclick="alert('Do you want to delete this todo?')"></i> </a>
                                        </li>
